/*
 * Copyright 2013 WML Inc. All Rights Reserved.
 * Author: hosschao@163.com (Chao Ma)
 */
package com.wml.suishouyou.widget;
...
public class ViewFlow extends AdapterView<Adapter> {
  ...
  private OnGlobalLayoutListener orientationChangeListener = new OnGlobalLayoutListener() {
    ...
    // TODO(chaoma): fix deprecated warning.
    @SuppressWarnings("deprecation")
    @Override
    public void onGlobalLayout() {
      // The guide of ViewTreeObserver:
  ...
  public static interface ViewSwitchListener {
     ...
     * @param position
     *          The position in the adapter of the {@link View} currently in
     *          focus.
     */
  ...
  private void init() {
    ...
    // The minimum distance to trigger moving event.
    mTouchSlop = configuration.getScaledTouchSlop();
    // The maximum velocity to trigger the fling(very fast move) event.
    mMaximumVelocity = configuration.getScaledMaximumFlingVelocity();
  }

  // The detail about configurationChanged, see
  ...
  // This function will be invoked by its parent view when deciding the layout.
  // The parent view asks: "how big the area do you want?" and give the
  // limitation(widthMeasureSpec, heightMeasureSpec)
  // by this function.
  @Override
  ...
  public boolean onInterceptTouchEvent(MotionEvent ev) {
    ...
    // when you tap your finger moving slowly, the view will follow your finger.
    ...
    case MotionEvent.ACTION_UP:
      if (mTouchState == TOUCH_STATE_SCROLLING) {
        ...
        // if trigger fling event, swap to the related view.
        if (velocityX > SNAP_VELOCITY && mCurrentScreen > 0) {
          ...
          // else, jump to the corrent view from current "two views"
          snapToDestination();
        }
  ...
  public void setSelection(int position) {
    ...
    /* disable switch event for creating a new instance
